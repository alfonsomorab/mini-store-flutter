...
class ItemProvider {
  ...
  Future<bool> createItem( ItemModel item ) async{
    ...
    final url = '$_url/items.json?auth=${ _preferences.token }';
  ...
  Future<int> updateItem( ItemModel item ) async{
    ...
    final url = '$_url/items/${ item.id }.json?auth=${ _preferences.token }';
  ...
  Future<int> deleteItem( String id ) async {
    final url = '$_url/items/$id.json?auth=${ _preferences.token }';
